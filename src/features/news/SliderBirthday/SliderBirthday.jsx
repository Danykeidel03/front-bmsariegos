...
import birthDayServices from '../../../api/apiBirthday';
...
const SliderBirthday = () => {
  ...
  return (
    <div className="slideBirthday" style={{ minHeight: '500px' }}>
      <Swiper
          ...
          <SwiperSlide key={index}>
            <div className="cardBirthday">
              ...
              <div className="birthInfo">
                ...
                <div className="date">
                  {day.daysUntil
                    ? `Quedan ${day.daysUntil} días para tu cumpleaños`
                    : `Felices ${calculateAge(day.birthDay)} años!!`}
                </div>
              </div>
            </div>
          </SwiperSlide>
