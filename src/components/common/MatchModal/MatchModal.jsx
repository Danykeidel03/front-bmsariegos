                    ...
                    <div key={match._id} className="game-item">
                      <div className="game-content">
                        ...
                        <div className="game-details">
                          <p>
                            <strong>Equipo:</strong> {match.ownTeam?.name || 'N/A'}
                          </p>
                          <p>
                            <strong>Rival:</strong> {match.rivalTeam?.name || 'N/A'}
                          </p>
                          <p>
                            <strong>Tipo:</strong> {match.isHome ? 'Local' : 'Suplente'}
                          </p>
                          {editingMatch === match._id ? (
                            <div className="edit-datetime">
                              <input
                                ...
                                onChange={(e) =>
                                  setEditDateTime({ ...editDateTime, date: e.target.value })
                                }
                              />
                              <input
                                type="time"
                                ...
                                onChange={(e) =>
                                  setEditDateTime({ ...editDateTime, time: e.target.value })
                                }
                              />
                              <button onClick={handleUpdateDateTime} className="save-btn">
                                Guardar
                              </button>
                      ...
                      <div className="game-actions">
                        ...
                        <button className="delete-btn" onClick={() => handleDelete(match._id)}>
                          Eliminar
                        </button>
                      </div>
                    </div>
