...
const SponsorModal = ({ isOpen, onClose, onSubmit }) => {
  ...
  return (
    <div className="modal-overlay" onClick={handleOverlayClick} onKeyDown={handleOverlayKeyDown}>
      <div className="modal-content">
        ...
        <form className="sponsor-form" onSubmit={handleSubmit}>
          ...
          <div className="form-group">
            <label>Logo</label>
            <input type="file" name="logo" onChange={handleChange} accept="image/*" required />
          </div>
